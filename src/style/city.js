...
const cityStyle = {
  ...
  cityContainer: 'flex-1 flex-col h-auto mx-4',
  ...
  forecastItemTitle: 'text-lg text-normal text-white',
  forecastItemValue: 'text-4xl font-semibold py-1',
  forecastIconWrapper: 'w-9 h-auto py-2',
  forecastDailyItemLabel: 'text-base text-normal text-white',
  forecastHourlyItemLabel: 'text-lg text-normal text-white',
